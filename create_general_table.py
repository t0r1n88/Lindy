            ...
            if re.search(pattern, filename):
                ...
                if temp_dpo.shape[0] > 0:
                    ...
                    temp_dpo['Дата_начала_курса'] = temp_dpo[
                        'Период_обучения_в_формате_с_дата_начала_по_дата_окончания'].apply(extract_date_begin_course)
                    ...
                    temp_dpo['Месяц_начала_курса'] = temp_dpo[
                        'Период_обучения_в_формате_с_дата_начала_по_дата_окончания'].apply(extract_month_begin_course)
