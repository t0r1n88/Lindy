...
df_dpo['Текущий возраст'] = df_dpo['Дата_рождения_получателя'].apply(calculate_age)
df_dpo['Возрастная категория'] = pd.cut(df_dpo['Текущий возраст'],[0,11,15,18,27,50,65,100],
                                        labels=['Младший возраст','12-15 лет','16-18 лет','19-27 лет','28-50 лет','51-65 лет','66 и больше'])

df_po['Текущий возраст'] = df_po['Дата_рождения_получателя'].apply(calculate_age)
df_po['Возрастная категория'] = pd.cut(df_po['Текущий возраст'],[0,11,15,18,27,50,65,100],
                                        labels=['Младший возраст','12-15 лет','16-18 лет','19-27 лет','28-50 лет','51-65 лет','66 и больше'])
