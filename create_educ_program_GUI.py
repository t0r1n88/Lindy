...
def create_educ_program():
    ...
    """
    try:
        name_file_template_educ_program = resource_path('Автошаблон_ПК_ЦОПП от 06_06_2022.docx')
        # Открываем таблицу
...
def create_educ_program_po():
    ...
    try:
        # Получаем шаблон
        name_file_template_educ_program_po = resource_path('Автошаблон_ПО_ЦОПП от 06_06_2022.docx')
        # Открываем таблицу
