...
def extract_date_begin_course(cell:str):
    ...
    try:
        ...
        print(cell)
        messagebox.showerror('Создание документов и отчетов ЦОПП версия 1.10', 'Проверьте правильность заполнения ячейки \nПериод_обучения_в_формате_с_дата_начала_по_дата_окончания!!!'
...
def create_initials(fio):
    ...
    if type(fio) == float:
        print(fio)
        messagebox.showerror('Создание документов и отчетов ЦОПП версия 1.10', 'Проверьте правильность написания ФИО в столбце ФИО_именительный')
        quit()
    ...
    try:
        ...
        if status_rb_type_doc == 0:
            ...
            try:
                ...
                messagebox.showerror('Создание документов и отчетов ЦОПП версия 1.10', 'Колонка с ФИО должна называться ФИО_именительный')
                quit()
            except:
            ...
            try:
                ...
                messagebox.showerror('Создание документов и отчетов ЦОПП версия 1.10', 'Закройте открытый файл Word')
                quit()
            except:
                messagebox.showerror('Создание документов и отчетов ЦОПП версия 1.10',
                                     'Проверьте содержимое шаблона\nНе допускаются любые символы кроме _ в словах внутри фигурных скобок\nСлова должны могут быть разделены нижним подчеркиванием')
...
def generate_docs_other():
    """
    Функция для создания документов из произвольных таблиц(т.е. отличающихся от структуры базы данных Создание документов и отчетов ЦОПП версия 1.10)
    :return:
    """
    try:
        # Получаем название для создаваемых документов
...
def create_report_one_pk():
    ...
    try:
        ...
        if df_dpo.shape[0] == 0:
            messagebox.showerror('Создание документов и отчетов ЦОПП версия 1.10', 'Лист с данными ПК не заполнен!')
        ...
        messagebox.showinfo('Создание документов и отчетов ЦОПП версия 1.10', 'Создание части отчета 1-ПК\nЗавершено!')
...
def create_report_one_po():
    ...
    try:
        ...
        if df_po.shape[0] == 0:
            messagebox.showerror('Создание документов и отчетов ЦОПП версия 1.10','Лист с данными ПО не заполнен!')
        ...
        messagebox.showinfo('Создание документов и отчетов ЦОПП версия 1.10', 'Создание части отчета 1-ПО\nЗавершено!')
...
def create_report_svod():
    ...
    try:
        ...
        messagebox.showerror('Создание документов и отчетов ЦОПП версия 1.10', 'Проверьте названия листов! Должно быть ДПО и ПО')
    # except KeyError:
    #     messagebox.showerror('Создание документов и отчетов ЦОПП версия 1.10', 'Названия колонок не совпадают')
    # except:
    #     messagebox.showerror('Создание документов и отчетов ЦОПП версия 1.10',
    #                          'Возникла ошибка')
    else:
        messagebox.showinfo('Создание документов и отчетов ЦОПП версия 1.10', 'Сводный отчет успешно создан!')
...
def create_general_table():
    ...
    #                          'Возникла ошибка,проверьте шаблон таблицы\nДобавляемы файлы должны иметь одинаковую структуру с шаблоном таблицы')
        ...
        messagebox.showinfo('Создание документов и отчетов ЦОПП версия 1.10', 'Общая таблица успешно создана!')
...
def calculate_data():
    ...
    if count_errors != 0:
        messagebox.showinfo('Создание документов и отчетов ЦОПП версия 1.10',
...
def create_report_indicator():
    ...
    try:
        ...
        messagebox.showinfo('Создание документов и отчетов ЦОПП версия 1.10','Создание отчета по индикаторам и госзаданию завершено')


if __name__ == '__main__':
    window = Tk()
    window.title('Создание документов и отчетов ЦОПП версия 1.10')
