...
def create_general_table():
    ...
    try:
        ...
        df_dpo['Дата_выдачи_документа'] = df_dpo['Дата_выдачи_документа'].apply(convert_date)
        df_dpo['Дата_рождения_получателя'] = df_dpo['Дата_рождения_получателя'].apply(convert_date)
        df_dpo['Дата_выдачи_паспорта'] = df_dpo['Дата_выдачи_паспорта'].apply(convert_date)

        df_po['Дата_выдачи_документа'] =df_po['Дата_выдачи_документа'].apply(convert_date)
        df_po['Дата_рождения_получателя'] = df_po['Дата_рождения_получателя'].apply(convert_date)
        df_po['Дата_выдачи_паспорта'] = df_po['Дата_выдачи_паспорта'].apply(convert_date)
